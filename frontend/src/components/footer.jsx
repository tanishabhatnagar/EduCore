      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">EduCore</tspan>
                    </text>
                  </g>
                </g>
              </svg>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            ...
            <ul class="leading-8">
            <li><a href="#" class="hover:text-blue-400">Introduction to Object-Oriented Programming (OOP)</a></li>
<li><a href="#" class="hover:text-blue-400">Understanding Database Management Systems (DBMS)</a></li>
<li><a href="#" class="hover:text-blue-400">Fundamentals of Computer Networks (CN)</a></li>
<li><a href="#" class="hover:text-blue-400">Exploring Operating Systems (OS)</a></li>
<li><a href="#" class="hover:text-blue-400">System Design Principles</a></li>
<li><a href="#" class="hover:text-blue-400">See More</a></li>
    ...
    <div class="bg-gray-900 py-4 text-gray-100">
